...
export const GemIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9.486-1.071L5.57 5.57m6.413 14.36L2.31 13.5m1.5-3.03L12 3m-3.03 7.5L3.75 3.75m6.413 1.82L12 9.429m3.03-3.03L12 3m-2.25 15l-5.25-5.25m9 5.25l5.25-5.25M12 3v18" />
  </svg>
);

export const LogoIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519 2.25 2.25 0 012.185.668l2.25 4.5V18H2.25z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6l2.25 4.5 1.5-1.5L8.25 15l1.5-1.5L12 15l2.25-2.25 1.5 1.5 2.25 4.5" />
...
export const FireIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a4.5 4.5 0 014.5 4.5v1.5a4.5 4.5 0 01-4.5 4.5h-1.5a4.5 4.5 0 01-4.5-4.5v-1.5a4.5 4.5 0 014.5-4.5H12z" />
    </svg>
);
...
export const CrownIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.362-3.797zM21 13.5a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 00.362-17.978V3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3L9 6h6L12 3z" />
    </svg>
);
